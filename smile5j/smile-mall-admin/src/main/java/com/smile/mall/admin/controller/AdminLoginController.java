...
import com.smile.mall.security.admin.dto.CaptchaAuthenticationDTO;
import com.smile.mall.security.common.bo.UserInfoInTokenBO;
import com.smile.mall.security.common.enums.SysTypeEnum;
import com.smile.mall.security.common.manager.PasswordCheckManager;
import com.smile.mall.security.common.manager.PasswordManager;
import com.smile.mall.security.common.manager.TokenStore;
...
import com.smile.mall.sys.model.SysUser;
import com.smile.mall.sys.service.SysMenuService;
import com.smile.mall.sys.service.SysUserService;
...
public class AdminLoginController 
{
            ...
            @Valid @RequestBody CaptchaAuthenticationDTO captchaAuthenticationDTO) 
    {
        ...
        if (sysUser == null) {
            throw new SmileMallBindException("账号或密码不正确");
        }
        ...
        if (Objects.equals(sysUser.getStatus(),0)) {
            // 未找到此用户信息
            throw new SmileMallBindException("未找到此用户信息");
        }
